...
gem "simplecov", "~> 0.19.0", group: :test

gem "shoulda-matchers", "~> 4.4", group: :test

gem "rails-i18n", "~> 6.0"

gem "standardrb", "~> 1.0", groups: [:development, :test]
...
gem "wkhtmltopdf-binary-edge", "~> 0.12.6", groups: [:development, :test]
